...
The purpose of this class is to have a fast, scalable abstraction layer between VERTEBRA input data and OpenGL in order to be able to support a variety of image formats. 

\subsection{Constructor \& Destructor Documentation}
\hypertarget{class_fast_image_a1ee91a3ac8ddcdfed90e9906bb3f0681}{
\index{FastImage@{FastImage}!FastImage@{FastImage}}
\index{FastImage@{FastImage}!FastImage@{FastImage}}
\subsubsection[{FastImage}]{\setlength{\rightskip}{0pt plus 5cm}FastImage::FastImage (
\begin{DoxyParamCaption}
\item[{QImage $\ast$}]{ img, }
\item[{bool}]{ enableGrayCache = {\ttfamily true}}
...
\subsubsection[{getGray}]{\setlength{\rightskip}{0pt plus 5cm}char FastImage::getGray (
\begin{DoxyParamCaption}
\item[{uint}]{ x, }
\item[{uint}]{ y}
\end{DoxyParamCaption}
...
\subsubsection[{getGray32bit}]{\setlength{\rightskip}{0pt plus 5cm}double FastImage::getGray32bit (
\begin{DoxyParamCaption}
\item[{uint}]{ x, }
\item[{uint}]{ y}
\end{DoxyParamCaption}
...
Gets the gray value (8 bit) for specific x and y pixel coordinates. The request is served from the gray cache if it has been enabled for this instance \hypertarget{class_fast_image_afda157efb702f601288d5e6c2e37a299}{
\index{FastImage@{FastImage}!getGrayQImage@{getGrayQImage}}
\index{getGrayQImage@{getGrayQImage}!FastImage@{FastImage}}
\subsubsection[{getGrayQImage}]{\setlength{\rightskip}{0pt plus 5cm}QImage $\ast$ FastImage::getGrayQImage (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{class_fast_image_afda157efb702f601288d5e6c2e37a299}
\begin{DoxyReturn}{Returns}
A QImage pointer generated from the data of this \hyperlink{class_fast_image}{FastImage} 
\end{DoxyReturn}
\hypertarget{class_fast_image_a1b90d63510575306ce345e393574d85c}{
...
\subsubsection[{getRgba}]{\setlength{\rightskip}{0pt plus 5cm}uint32\_\-t FastImage::getRgba (
\begin{DoxyParamCaption}
\item[{uint}]{ x, }
\item[{uint}]{ y}
\end{DoxyParamCaption}
...
\subsubsection[{setGrayPixel}]{\setlength{\rightskip}{0pt plus 5cm}void FastImage::setGrayPixel (
\begin{DoxyParamCaption}
\item[{uint}]{ x, }
\item[{uint}]{ y, }
\item[{uint32\_\-t}]{ val}
...
\subsubsection[{setPixel}]{\setlength{\rightskip}{0pt plus 5cm}void FastImage::setPixel (
\begin{DoxyParamCaption}
\item[{uint}]{ x, }
\item[{uint}]{ y, }
\item[{uint32\_\-t}]{ val}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{class_fast_image_adcf6d77e79c1f75f2420c6db0d96951d_icgraph}
\end{center}
\end{figure}
